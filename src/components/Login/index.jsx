    ...
    return (
            <form onSubmit={handleSubmit} className='login'>
                <div className='login__item'>
                    <h2 className='login__item-label'>帳號：</h2>
                    <input onChange={event => handleSave(event, "account")} className='login__item-input' value={account} maxLength={20} type="text" />
                </div>
                <div className='login__item'>
                    <h2 className='login__item-label'>密碼：</h2>
                    <input onChange={event => handleSave(event, "password")} className='login__item-input' value={password} maxLength={20} type={showPassword ? "text" : "password"} />
