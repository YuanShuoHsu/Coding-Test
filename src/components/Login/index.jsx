    ...
    return (
        <form onSubmit={handleSubmit} className='login'>
            ...
            <div className='login__item'>
                ...
                <label onClick={() => handlePassword("showPassword")} className={`login__item--inactive ${showPassword ? "active" : ""}`}>
                ...
                <label onClick={() => handlePassword("hidePassword")} className={`login__item--active ${showPassword ? "" : "active"}`}>
            ...
            {error && <p className='login__error'>{t(error)}</p>}
        </form>
    )
}
